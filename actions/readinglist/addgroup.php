...
add_entity_relationship($book->guid, READING_LIST_RELATIONSHIP, $group->guid);
...
system_message(elgg_echo('readinglist:success:groupreadinglistadd'));
forward(REFERER);